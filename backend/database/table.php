...
$tablesToDrop = ['db3', 'db2', 'db1_1', 'db1', 'db0', 'db4', 'db5', 'accounts'];
...
$tableDefinitions = [
    ...
    'db5' => [
        'title' => 'ステップ11: db5テーブル（動物図鑑）',
        'sql'   => "CREATE TABLE db5 (
            id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            user_id INT(11) UNSIGNED NULL COMMENT '利用者ID',
            animal_name VARCHAR(255) NOT NULL COMMENT '動物名',
            description TEXT NULL COMMENT '動物の説明文',
            gif_url TEXT NULL COMMENT 'GIF画像URL',
            INDEX idx_animal_name (animal_name),
            INDEX idx_user (user_id),
            CONSTRAINT fk_db5_user FOREIGN KEY (user_id) REFERENCES db4(id) ON DELETE SET NULL
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
        COMMENT='動物図鑑テーブル'"
    ],
];
